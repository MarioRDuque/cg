...
public class Individual implements Comparable<Individual>, Cloneable {
    ...
    public void calcularFitness() {
        ...
        this.personWorkLists = new ArrayList<>();
        List<TreeSet<WorkUnit>> unlockedPersonWorkLists = new ArrayList<>();
        ...
        for (int index = 0; index < projectCount; index++) {
            personWorkLists.add(new TreeSet<>());
    ...
    public int compareTo(Individual other) {
        ...
        if (this.actualDuration > other.actualDuration) {
            return 1;
        }
        if (this.actualDuration < other.actualDuration) {
            return -1;
        ...
        if (this.waitDuration > other.waitDuration) {
            return 1;
        }
        if (this.waitDuration < other.waitDuration) {
            return -1;
    ...
    public Individual clone() {
        ...
        List<ArrayList<WorkUnit>> clonedProjectWorkLists = new ArrayList<>();

        for (ArrayList<WorkUnit> projectWorkList : this.getProjectWorkLists()) {

            ArrayList<WorkUnit> clonedProjectWorkList = new ArrayList<>();
            for (WorkUnit workUnit : projectWorkList) {
